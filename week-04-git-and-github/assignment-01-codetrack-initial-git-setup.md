...
.git folder is a hidden directory/folder at the root of a project. It stores configuration settings and metadata that does history management, version tracking and commits management. It is this file initialization that makes a directory a git directory.
